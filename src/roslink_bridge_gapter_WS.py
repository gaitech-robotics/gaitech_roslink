...
class ROSLinkBridgeGapter:
    ...
    def init_servers():
        ...
        print("ws connection params set",ROSLinkStateVariables.WSconnected)
    ...
    @staticmethod
    def websocketThread():
        if(not ROSLinkStateVariables.WSconnected):
    ...
    def create_roslink_message_threads(): 
        ...
        ROSLinkBridgeGapter.robot_status_thread = ROSLinkMessageThread(ROSLinkBridgeGapter.client_socket, ROSLinkBridgeGapter.ws, ROSLinkBridgeGapter.server_address, MESSAGE_TYPE.ROSLINK_MESSAGE_ROBOT_STATUS, "robot_status_thread", ROSLinkBridgeGapter.robot_status_msg_rate)
