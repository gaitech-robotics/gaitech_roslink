...
import time
import json
# killall udhcpd; iwconfig ath0 mode managed essid lab; ifconfig ath0 192.168.43.72 netmask 255.255.255.0 up;
import rospy
import tf
...
class ROSLinkBridgeARDrone:
    ...
    def static_build_ROSLink_image_message():
        message_header = ROSLinkBridgeARDrone.static_build_roslink_header_message(MESSAGE_TYPE.ROSLINK_MESSAGE_ROSLINK_GEO_TAGED_IMAGE) 
